...
Featured Requests:  For the scope of this project, it will be the following:
•	Roster – Keep a list of each player on the team and any relevant information. Provide ability to add a player. The primary key is the jersey number.
